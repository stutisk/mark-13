var bdayInput = document.querySelector('#inputDate');
...
function clickHandler(e) {
  ...
  if (bdayString !== '') {
    ...
    if (!isPalindrome) {
      ...
      if (ctr1 > ctr2) {
        outPut.innerText = ` sorry ! your birthday is not a palindrome ,The nearest palindrome date is ${prevDate.day}-${prevDate.month}-${prevDate.year}, you missed by ${ctr2} days. `;
        outPut.style.color="red";
      } else {
        outPut.innerText = `sorry ! your birthday is not a palindrome ,The nearest palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed by ${ctr1} days. `;
        outPut.style.color="red";
      }
